              ...
              <div class="card-body">
                @if($b -> statuspembayaran == 0)
                  <div class="alert alert-danger" role="alert">
                    Tolong segera selesaikan pembayaran! Klik <a href="#">Disini!</a> Untuk selesaikan pembayaran.
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item"><b>{{ $b -> product -> jeniskain }}</b></li>
                      <li class="list-group-item"><b>{{ $b -> desain -> nama }}</b></li>
                      <li class="list-group-item"><b>{{ $b -> color -> Warna }}</b></li>
                    </ul>
                  </div>
                </div>
              </div>
